...
from coco.models import Country, State, District, Block, Sublocation, Village, Person, Cluster, SHGBaseLine, SHGProgram, LoanType, LoanSubType
from coco.models import Loan, ExpectedReceipt, ActualReceipt
